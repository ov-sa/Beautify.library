...
function renderScrollbar(elementParent, renderData, referenceData)
    ...
    local scrollbar_width, scrollbar_height, scrollbar_overflownSize, scrollbar_thumb_size = nil, nil, renderData.overflownSize, nil
        ...
        if currentScrollState[1] then
            if currentScrollState[1] == "up" then
                if referenceData.finalPercent > 0 then
                    if scrollbar_overflownSize < scrollbar_height then scrollbar_scrollSpeed = scrollbar_scrollSpeed*25 end
