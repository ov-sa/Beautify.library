...
function renderWindow(element)
    ...
    if window_width > availableElements["beautify_window"].__minimumSize then
        dxDrawRectangle(window_startX + window_borderSize, window_startY, window_width - availableElements["beautify_window"].__minimumSize, window_borderSize, window_color, window_postGUI, true)
    ...
    if window_height > availableElements["beautify_window"].__minimumSize then
        dxDrawRectangle(window_startX, window_startY + window_borderSize, window_borderSize, window_height - availableElements["beautify_window"].__minimumSize, window_color, window_postGUI, true)
        dxDrawRectangle(window_startX + window_width - window_borderSize, window_startY + window_borderSize, window_borderSize, window_height - availableElements["beautify_window"].__minimumSize, window_color, window_postGUI, true)
    end
    ...
    if (window_width >= window_titleBar_height) and (window_height >= window_titleBar_height) then
        ...
        dxDrawLine(window_startX, window_startY + window_titleBar_height, window_startX + window_width - window_titleBar_height, window_startY + window_titleBar_height, tocolor(0, 0, 0, 150), 2, window_postGUI)
