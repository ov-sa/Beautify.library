...
local _sX = CLIENT_MTA_RESOLUTION[1]/1366; _sY = CLIENT_MTA_RESOLUTION[2]/768;
...
local function devUI1()
    ...
    local createdWindow = createWindow(50, (CLIENT_MTA_RESOLUTION[2] - window_height)/2, window_width, window_height, "Development UI #1", nil, false)
...
local function devUI2()
    ...
    local createdWindow = createWindow(750 + 50, (CLIENT_MTA_RESOLUTION[2] - window_height)/2, window_width, window_height, "Development UI #2", nil, false)
    ...
    setSliderPercent(createdSlider, math.random(0, 100))
    setSliderPercent(createdSlider2, math.random(0, 100))
    setSliderPercent(createdSlider3, math.random(0, 100))
    setSliderPercent(createdSlider4, math.random(0, 100))
    setSliderPercent(createdSlider5, math.random(0, 100))
    ...
    setSliderPercent(createdSlider6, math.random(0, 100))
    setSliderPercent(createdSlider7, math.random(0, 100))
    setSliderPercent(createdSlider8, math.random(0, 100))
    setSliderPercent(createdSlider9, math.random(0, 100))
