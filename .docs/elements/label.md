...
```
##### _**#Counterpart: [getLabelText](https://github.com/OvileAmriam/MTA-Beautify-Library/wiki/Label#-getLabelText)**_
- ### **Parameters:**
...
```
##### _**#Counterpart: [setLabelText](https://github.com/OvileAmriam/MTA-Beautify-Library/wiki/Label#-setLabelText)**_
- ### **Parameters:**
...
```
##### _**#Counterpart: [getLabelColor](https://github.com/OvileAmriam/MTA-Beautify-Library/wiki/Label#-getLabelColor)**_
- ### **Parameters:**
...
```
##### _**#Counterpart: [setLabelColor](https://github.com/OvileAmriam/MTA-Beautify-Library/wiki/Label#-setLabelColor)**_
- ### **Parameters:**
...
```
##### _**#Counterpart: [getLabelHorizontalAlignment](https://github.com/OvileAmriam/MTA-Beautify-Library/wiki/Label#-getLabelHorizontalAlignment)**_
- ### **Parameters:**
...
```
##### _**#Counterpart: [setLabelHorizontalAlignment](https://github.com/OvileAmriam/MTA-Beautify-Library/wiki/Label#-setLabelHorizontalAlignment)**_
- ### **Parameters:**
...
```
##### _**#Counterpart: [getLabelVerticalAlignment](https://github.com/OvileAmriam/MTA-Beautify-Library/wiki/Label#-getLabelVerticalAlignment)**_
- ### **Parameters:**
...
```
##### _**#Counterpart: [setLabelVerticalAlignment](https://github.com/OvileAmriam/MTA-Beautify-Library/wiki/Label#-setLabelVerticalAlignment)**_
- ### **Parameters:**
